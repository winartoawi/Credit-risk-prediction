...
# check the boxplot of target variable vs number of times late of 30 - 59 days 
ggplot(ds_pmm, aes(x=class, y=PD30.60,group=class)) +
  theme_bw()+
  geom_boxplot( fill = "blue", alpha = 0.2)+
  theme(legend.position='none')+ coord_flip()+
  labs(title = "Delinquency vs. NUmber of times late of 30 - 59 days", y="NUmber of times late of 30 - 59 days", x="non-default = 0, Default = 1")
